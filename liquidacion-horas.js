const $=id=>document.getElementById(id);const state={rows:[],holidays:new Set(),values:{extra:0,cien:0,feriado:0},period:null,cal:new Map(),file:null,expandedEmployees:new Set()};

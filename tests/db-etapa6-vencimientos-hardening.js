...
ok(server.includes("obtenerVencimientosLegacy"), "Debe existir una ruta explícita de importación inicial desde Sheets");
ok(server.includes("la hoja Vencimientos queda como respaldo histórico"), "Debe quedar explícito que Sheets solo participa como respaldo tras migrar Etapa 6");
...
ok(server.includes('PostgreSQL Etapa 6: Usuarios, Sectores, Horarios, Tareas, Baño, Inventario, Productos y Vencimientos listos.'), "Falta señal de inicialización Etapa 6");

...
assert(!server.includes("async function crearProductoInventario("), "No debe quedar el wrapper sin uso crearProductoInventario");
assert(server.includes("const maestro = await buscarProductoMaestroPorCodigo(codigoBuscado);"), "El alta debe resolver el artículo desde PostgreSQL");

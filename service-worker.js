const CACHE_PREFIX = 'autoservicio-v1222';
const CACHE_VERSION = 'autoservicio-v1222';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1222',
  './style.css?v=1222',
  './design-components.css?v=1222',
  './app-shell.css?v=1222',
  './app.js?v=1222',
  './config.js?v=1222',
  './excel.js?v=1222',
  './scanner.js?v=1222',
  './reposicion.js?v=1222',
  './ui.js?v=1222',
  './module-registry.js?v=1222',
  './shared/dom-utils.js?v=1222',
  './modules/tareas/task-view.js?v=1222',
  './modules/horarios/schedule-format.js?v=1222',
  './pwa.js?v=1222',
  './search.js?v=1222',
  './horarios-config.js?v=1222',
  './admin.js?v=1222',
  './auth.js?v=1222',

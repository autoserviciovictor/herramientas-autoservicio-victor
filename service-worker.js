...
const CACHE_VERSION = 'autoservicio-v11.8';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1180',
  './style.css?v=1180',
  './design-components.css?v=1180',
  './app-shell.css?v=1180',
  './app.js?v=1180',
  './config.js?v=1180',
  './excel.js?v=1180',
  './scanner.js?v=1180',
  './reposicion.js?v=1180',
  './ui.js?v=1180',
  './module-registry.js?v=1180',
  './shared/dom-utils.js?v=1180',
  './modules/tareas/task-view.js?v=1180',
  './modules/horarios/schedule-format.js?v=1180',
  './pwa.js?v=1180',
  './search.js?v=1180',
  './horarios-config.js?v=1180',
  './admin.js?v=1180',
  './auth.js?v=1180',
  './notifications.js?v=1180',
  './prices.js?v=1180',
  './horarios.js?v=1180',
  './api-cache.js?v=1180',
  './tareas.js?v=1180',

const CACHE_PREFIX = 'autoservicio-v1182';
const CACHE_VERSION = 'autoservicio-v11.8.2';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1182',
  './style.css?v=1182',
  './design-components.css?v=1182',
  './app-shell.css?v=1182',
  './app.js?v=1182',
  './config.js?v=1182',
  './excel.js?v=1182',
  './scanner.js?v=1182',
  './reposicion.js?v=1182',
  './ui.js?v=1182',
  './module-registry.js?v=1182',
  './shared/dom-utils.js?v=1182',
  './modules/tareas/task-view.js?v=1182',
  './modules/horarios/schedule-format.js?v=1182',
  './pwa.js?v=1182',
  './search.js?v=1182',
  './horarios-config.js?v=1182',
  './admin.js?v=1182',
  './auth.js?v=1182',
  './notifications.js?v=1182',
  './prices.js?v=1182',
  './horarios.js?v=1182',
  './api-cache.js?v=1182',
  './tareas.js?v=1182',

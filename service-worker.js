...
const CACHE_VERSION = 'autoservicio-v11.8.1';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1181',
  './style.css?v=1181',
  './design-components.css?v=1181',
  './app-shell.css?v=1181',
  './app.js?v=1181',
  './config.js?v=1181',
  './excel.js?v=1181',
  './scanner.js?v=1181',
  './reposicion.js?v=1181',
  './ui.js?v=1181',
  './module-registry.js?v=1181',
  './shared/dom-utils.js?v=1181',
  './modules/tareas/task-view.js?v=1181',
  './modules/horarios/schedule-format.js?v=1181',
  './pwa.js?v=1181',
  './search.js?v=1181',
  './horarios-config.js?v=1181',
  './admin.js?v=1181',
  './auth.js?v=1181',
  './notifications.js?v=1181',
  './prices.js?v=1181',
  './horarios.js?v=1181',
  './api-cache.js?v=1181',
  './tareas.js?v=1181',

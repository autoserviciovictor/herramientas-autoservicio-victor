const CACHE_PREFIX = 'autoservicio-v1212';
const CACHE_VERSION = 'autoservicio-v1212';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1211',
  './style.css?v=1211',
  './design-components.css?v=1211',
  './app-shell.css?v=1211',
  './app.js?v=1211',
  './config.js?v=1211',
  './excel.js?v=1211',
  './scanner.js?v=1211',
  './reposicion.js?v=1211',
  './ui.js?v=1211',
  './module-registry.js?v=1211',
  './shared/dom-utils.js?v=1211',
  './modules/tareas/task-view.js?v=1211',
  './modules/horarios/schedule-format.js?v=1211',
  './pwa.js?v=1211',
  './search.js?v=1211',
  './horarios-config.js?v=1211',
  './admin.js?v=1211',
  './auth.js?v=1211',

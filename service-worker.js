const CACHE_PREFIX = 'autoservicio-v1210';
const CACHE_VERSION = 'autoservicio-v1210';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1210',
  './style.css?v=1210',
  './design-components.css?v=1210',
  './app-shell.css?v=1210',
  './app.js?v=1210',
  './config.js?v=1210',
  './excel.js?v=1210',
  './scanner.js?v=1210',
  './reposicion.js?v=1210',
  './ui.js?v=1210',
  './module-registry.js?v=1210',
  './shared/dom-utils.js?v=1210',
  './modules/tareas/task-view.js?v=1210',
  './modules/horarios/schedule-format.js?v=1210',
  './pwa.js?v=1210',
  './search.js?v=1210',
  './horarios-config.js?v=1210',
  './admin.js?v=1210',
  './auth.js?v=1210',
  './notifications.js?v=1210',
  './prices.js?v=1210',
  './horarios.js?v=1210',
  './api-cache.js?v=1210',
  './tareas.js?v=1210',

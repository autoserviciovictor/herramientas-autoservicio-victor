const CACHE_PREFIX = 'autoservicio-v1202';
const CACHE_VERSION = 'autoservicio-v12.0.2';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1202',
  './style.css?v=1202',
  './design-components.css?v=1202',
  './app-shell.css?v=1202',
  './app.js?v=1202',
  './config.js?v=1202',
  './excel.js?v=1202',
  './scanner.js?v=1202',
  './reposicion.js?v=1202',
  './ui.js?v=1202',
  './module-registry.js?v=1202',
  './shared/dom-utils.js?v=1202',
  './modules/tareas/task-view.js?v=1202',
  './modules/horarios/schedule-format.js?v=1202',
  './pwa.js?v=1202',
  './search.js?v=1202',
  './horarios-config.js?v=1202',
  './admin.js?v=1202',
  './auth.js?v=1202',
  './notifications.js?v=1202',
  './prices.js?v=1202',
  './horarios.js?v=1202',
  './api-cache.js?v=1202',
  './tareas.js?v=1202',

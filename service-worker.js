...
const CACHE_VERSION = 'autoservicio-v1121-stable';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1121',
  './style.css?v=1121',
  './design-components.css?v=1121',
  './app-shell.css?v=1121',
  './app.js?v=1121',
  './config.js?v=1121',
  './excel.js?v=1121',
  './scanner.js?v=1121',
  './reposicion.js?v=1121',
  './ui.js?v=1121',
  './module-registry.js?v=1121',
  './shared/dom-utils.js?v=1121',
  './modules/tareas/task-view.js?v=1121',
  './modules/horarios/schedule-format.js?v=1121',
  './pwa.js?v=1121',
  './search.js?v=1121',
  './horarios-config.js?v=1121',
  './admin.js?v=1121',
  './auth.js?v=1121',
  './notifications.js?v=1121',
  './prices.js?v=1121',
  './horarios.js?v=1121',
  './api-cache.js?v=1121',
  './tareas.js?v=1121',

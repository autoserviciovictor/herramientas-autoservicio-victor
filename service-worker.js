const CACHE_PREFIX = 'autoservicio-v1221';
const CACHE_VERSION = 'autoservicio-v1221';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1221',
  './style.css?v=1221',
  './design-components.css?v=1221',
  './app-shell.css?v=1221',
  './app.js?v=1221',
  './config.js?v=1221',
  './excel.js?v=1221',
  './scanner.js?v=1221',
  './reposicion.js?v=1221',
  './ui.js?v=1221',
  './module-registry.js?v=1221',
  './shared/dom-utils.js?v=1221',
  './modules/tareas/task-view.js?v=1221',
  './modules/horarios/schedule-format.js?v=1221',
  './pwa.js?v=1221',
  './search.js?v=1221',
  './horarios-config.js?v=1221',
  './admin.js?v=1221',
  './auth.js?v=1221',
  './notifications.js?v=1221',
  './prices.js?v=1221',
  './horarios.js?v=1221',
  './api-cache.js?v=1221',
  './tareas.js?v=1221',

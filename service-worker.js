const CACHE_PREFIX = 'autoservicio-v1224';
const CACHE_VERSION = 'autoservicio-v1224';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1224',
  './style.css?v=1224',
  './design-components.css?v=1224',
  './app-shell.css?v=1224',
  './app.js?v=1224',
  './config.js?v=1224',
  './excel.js?v=1224',
  './scanner.js?v=1224',
  './reposicion.js?v=1224',
  './ui.js?v=1224',
  './module-registry.js?v=1224',
  './shared/dom-utils.js?v=1224',
  './modules/tareas/task-view.js?v=1224',
  './modules/horarios/schedule-format.js?v=1224',
  './pwa.js?v=1224',
  './search.js?v=1224',
  './horarios-config.js?v=1224',
  './admin.js?v=1224',
  './auth.js?v=1224',

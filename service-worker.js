...
const CACHE_VERSION = 'autoservicio-v1244';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1244',
  './style.css?v=1244',
  './design-components.css?v=1244',
  './app-shell.css?v=1244',
  './desktop-layout.css?v=1244',
  './app.js?v=1244',
  './config.js?v=1244',
  './excel.js?v=1244',
  './scanner.js?v=1244',
  './reposicion.js?v=1244',
  './ui.js?v=1244',
  './module-registry.js?v=1244',
  './shared/dom-utils.js?v=1244',
  './modules/tareas/task-view.js?v=1244',
  './modules/horarios/schedule-format.js?v=1244',
  './pwa.js?v=1244',
  './search.js?v=1244',
  './horarios-config.js?v=1244',
  './admin.js?v=1244',
  './auth.js?v=1244',
  './notifications.js?v=1244',
  './prices.js?v=1244',
  './horarios.js?v=1244',
  './api-cache.js?v=1244',
  './tareas.js?v=1244',

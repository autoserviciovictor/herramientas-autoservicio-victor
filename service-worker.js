const CACHE_PREFIX = 'autoservicio-v1191';
const CACHE_VERSION = 'autoservicio-v11.9.1';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1191',
  './style.css?v=1191',
  './design-components.css?v=1191',
  './app-shell.css?v=1191',
  './app.js?v=1191',
  './config.js?v=1191',
  './excel.js?v=1191',
  './scanner.js?v=1191',
  './reposicion.js?v=1191',
  './ui.js?v=1191',
  './module-registry.js?v=1191',
  './shared/dom-utils.js?v=1191',
  './modules/tareas/task-view.js?v=1191',
  './modules/horarios/schedule-format.js?v=1191',
  './pwa.js?v=1191',
  './search.js?v=1191',
  './horarios-config.js?v=1191',
  './admin.js?v=1191',
  './auth.js?v=1191',
  './notifications.js?v=1191',
  './prices.js?v=1191',
  './horarios.js?v=1191',
  './api-cache.js?v=1191',
  './tareas.js?v=1191',

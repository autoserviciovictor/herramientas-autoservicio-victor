...
const CACHE_VERSION = 'autoservicio-v815-canal-estable-1';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './style.css?v=815-entrega5',
  './app.js?v=815-entrega5',
  './config.js?v=815-entrega5',
  './excel.js?v=815-entrega5',
  ...
  './admin.js?v=815-entrega5',
  './auth.js?v=815-entrega5',
  './notifications.js?v=815-entrega5',
  './prices.js?v=815-entrega5',

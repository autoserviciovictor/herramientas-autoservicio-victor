const CACHE_PREFIX = 'autoservicio-v1242';
const CACHE_VERSION = 'autoservicio-v1242';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1242',
  './style.css?v=1242',
  './design-components.css?v=1242',
  './app-shell.css?v=1242',
  './desktop-layout.css?v=1242',
  './app.js?v=1242',
  './config.js?v=1242',
  './excel.js?v=1242',
  './scanner.js?v=1242',
  './reposicion.js?v=1242',
  './ui.js?v=1242',
  './module-registry.js?v=1242',
  './shared/dom-utils.js?v=1242',
  './modules/tareas/task-view.js?v=1242',
  './modules/horarios/schedule-format.js?v=1242',
  './pwa.js?v=1242',
  './search.js?v=1242',
  './horarios-config.js?v=1242',
  './admin.js?v=1242',
  './auth.js?v=1242',
  './notifications.js?v=1242',
  './prices.js?v=1242',
  './horarios.js?v=1242',
  './api-cache.js?v=1242',
  './tareas.js?v=1242',

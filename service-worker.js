const CACHE_PREFIX = 'autoservicio-v1201';
const CACHE_VERSION = 'autoservicio-v12.0.1';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1201',
  './style.css?v=1201',
  './design-components.css?v=1201',
  './app-shell.css?v=1201',
  './app.js?v=1201',
  './config.js?v=1201',
  './excel.js?v=1201',
  './scanner.js?v=1201',
  './reposicion.js?v=1201',
  './ui.js?v=1201',
  './module-registry.js?v=1201',
  './shared/dom-utils.js?v=1201',
  './modules/tareas/task-view.js?v=1201',
  './modules/horarios/schedule-format.js?v=1201',
  './pwa.js?v=1201',
  './search.js?v=1201',
  './horarios-config.js?v=1201',
  './admin.js?v=1201',
  './auth.js?v=1201',
  './notifications.js?v=1201',
  './prices.js?v=1201',
  './horarios.js?v=1201',
  './api-cache.js?v=1201',
  './tareas.js?v=1201',

const CACHE_PREFIX = 'autoservicio-v1190';
const CACHE_VERSION = 'autoservicio-v11.9.0';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1190',
  './style.css?v=1190',
  './design-components.css?v=1190',
  './app-shell.css?v=1190',
  './app.js?v=1190',
  './config.js?v=1190',
  './excel.js?v=1190',
  './scanner.js?v=1190',
  './reposicion.js?v=1190',
  './ui.js?v=1190',
  './module-registry.js?v=1190',
  './shared/dom-utils.js?v=1190',
  './modules/tareas/task-view.js?v=1190',
  './modules/horarios/schedule-format.js?v=1190',
  './pwa.js?v=1190',
  './search.js?v=1190',
  './horarios-config.js?v=1190',
  './admin.js?v=1190',
  './auth.js?v=1190',
  './notifications.js?v=1190',
  './prices.js?v=1190',
  './horarios.js?v=1190',
  './api-cache.js?v=1190',
  './tareas.js?v=1190',

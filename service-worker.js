const CACHE_PREFIX = 'autoservicio-v1223';
const CACHE_VERSION = 'autoservicio-v1223';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1223',
  './style.css?v=1223',
  './design-components.css?v=1223',
  './app-shell.css?v=1223',
  './app.js?v=1223',
  './config.js?v=1223',
  './excel.js?v=1223',
  './scanner.js?v=1223',
  './reposicion.js?v=1223',
  './ui.js?v=1223',
  './module-registry.js?v=1223',
  './shared/dom-utils.js?v=1223',
  './modules/tareas/task-view.js?v=1223',
  './modules/horarios/schedule-format.js?v=1223',
  './pwa.js?v=1223',
  './search.js?v=1223',
  './horarios-config.js?v=1223',
  './admin.js?v=1223',
  './auth.js?v=1223',

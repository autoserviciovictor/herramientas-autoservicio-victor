...
const CACHE_VERSION = 'autoservicio-v1120-stable';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1120',
  './style.css?v=1120',
  './design-components.css?v=1120',
  './app-shell.css?v=1120',
  './app.js?v=1120',
  './config.js?v=1120',
  './excel.js?v=1120',
  './scanner.js?v=1120',
  './reposicion.js?v=1120',
  './ui.js?v=1120',
  './module-registry.js?v=1120',
  './shared/dom-utils.js?v=1120',
  './modules/tareas/task-view.js?v=1120',
  './modules/horarios/schedule-format.js?v=1120',
  './pwa.js?v=1120',
  './search.js?v=1120',
  './horarios-config.js?v=1120',
  './admin.js?v=1120',
  './auth.js?v=1120',
  './notifications.js?v=1120',
  './prices.js?v=1120',
  './horarios.js?v=1120',
  './api-cache.js?v=1120',
  './tareas.js?v=1120',

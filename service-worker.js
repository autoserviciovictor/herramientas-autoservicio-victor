const CACHE_PREFIX = 'autoservicio-v1245';
const CACHE_VERSION = 'autoservicio-v1245';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1245',
  './style.css?v=1245',
  './design-components.css?v=1245',
  './app-shell.css?v=1245',
  './app.js?v=1245',
  './config.js?v=1245',
  './excel.js?v=1245',
  './scanner.js?v=1245',
  './reposicion.js?v=1245',
  './ui.js?v=1245',
  './module-registry.js?v=1245',
  './shared/dom-utils.js?v=1245',
  './modules/tareas/task-view.js?v=1245',
  './modules/horarios/schedule-format.js?v=1245',
  './pwa.js?v=1245',
  './search.js?v=1245',
  './horarios-config.js?v=1245',
  './admin.js?v=1245',
  './auth.js?v=1245',
  './notifications.js?v=1245',
  './prices.js?v=1245',
  './horarios.js?v=1245',
  './api-cache.js?v=1245',
  './tareas.js?v=1245',

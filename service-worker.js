...
const APP_SHELL = [
  ...
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1243',
  './style.css?v=1243',
  './design-components.css?v=1243',
  './app-shell.css?v=1243',
  './desktop-layout.css?v=1243',
  './app.js?v=1243',
  './config.js?v=1243',
  './excel.js?v=1243',
  './scanner.js?v=1243',
  './reposicion.js?v=1243',
  './ui.js?v=1243',
  './module-registry.js?v=1243',
  './shared/dom-utils.js?v=1243',
  './modules/tareas/task-view.js?v=1243',
  './modules/horarios/schedule-format.js?v=1243',
  './pwa.js?v=1243',
  './search.js?v=1243',
  './horarios-config.js?v=1243',
  './admin.js?v=1243',
  './auth.js?v=1243',

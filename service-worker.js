...
const CACHE_VERSION = 'autoservicio-v1140-stable';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1140',
  './style.css?v=1140',
  './design-components.css?v=1140',
  './app-shell.css?v=1140',
  './app.js?v=1140',
  './config.js?v=1140',
  './excel.js?v=1140',
  './scanner.js?v=1140',
  './reposicion.js?v=1140',
  './ui.js?v=1140',
  './module-registry.js?v=1140',
  './shared/dom-utils.js?v=1140',
  './modules/tareas/task-view.js?v=1140',
  './modules/horarios/schedule-format.js?v=1140',
  './pwa.js?v=1140',
  './search.js?v=1140',
  './horarios-config.js?v=1140',
  './admin.js?v=1140',
  './auth.js?v=1140',
  './notifications.js?v=1140',
  './prices.js?v=1140',
  './horarios.js?v=1140',
  './api-cache.js?v=1140',
  './tareas.js?v=1140',

...
const CACHE_VERSION = 'autoservicio-v1132-stable';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1132',
  './style.css?v=1132',
  './design-components.css?v=1132',
  './app-shell.css?v=1132',
  './app.js?v=1132',
  './config.js?v=1132',
  './excel.js?v=1132',
  './scanner.js?v=1132',
  './reposicion.js?v=1132',
  './ui.js?v=1132',
  './module-registry.js?v=1132',
  './shared/dom-utils.js?v=1132',
  './modules/tareas/task-view.js?v=1132',
  './modules/horarios/schedule-format.js?v=1132',
  './pwa.js?v=1132',
  './search.js?v=1132',
  './horarios-config.js?v=1132',
  './admin.js?v=1132',
  './auth.js?v=1132',
  './notifications.js?v=1132',
  './prices.js?v=1132',
  './horarios.js?v=1132',
  './api-cache.js?v=1132',
  './tareas.js?v=1132',

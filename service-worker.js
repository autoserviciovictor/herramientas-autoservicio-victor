const CACHE_PREFIX = 'autoservicio-v12301';
const CACHE_VERSION = 'autoservicio-v12301';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=12301',
  './style.css?v=12301',
  './design-components.css?v=12301',
  './app-shell.css?v=12301',
  './app.js?v=12301',
  './config.js?v=12301',
  './excel.js?v=12301',
  './scanner.js?v=12301',
  './reposicion.js?v=12301',
  './ui.js?v=12301',
  './module-registry.js?v=12301',
  './shared/dom-utils.js?v=12301',
  './modules/tareas/task-view.js?v=12301',
  './modules/horarios/schedule-format.js?v=12301',
  './pwa.js?v=12301',
  './search.js?v=12301',
  './horarios-config.js?v=12301',
  './admin.js?v=12301',
  './auth.js?v=12301',
  './notifications.js?v=12301',
  './prices.js?v=12301',
  './horarios.js?v=12301',
  './api-cache.js?v=12301',
  './tareas.js?v=12301',

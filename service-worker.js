const CACHE_PREFIX = 'autoservicio-v1192';
const CACHE_VERSION = 'autoservicio-v11.9.2';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1192',
  './style.css?v=1192',
  './design-components.css?v=1192',
  './app-shell.css?v=1192',
  './app.js?v=1192',
  './config.js?v=1192',
  './excel.js?v=1192',
  './scanner.js?v=1192',
  './reposicion.js?v=1192',
  './ui.js?v=1192',
  './module-registry.js?v=1192',
  './shared/dom-utils.js?v=1192',
  './modules/tareas/task-view.js?v=1192',
  './modules/horarios/schedule-format.js?v=1192',
  './pwa.js?v=1192',
  './search.js?v=1192',
  './horarios-config.js?v=1192',
  './admin.js?v=1192',
  './auth.js?v=1192',
  './notifications.js?v=1192',
  './prices.js?v=1192',
  './horarios.js?v=1192',
  './api-cache.js?v=1192',
  './tareas.js?v=1192',

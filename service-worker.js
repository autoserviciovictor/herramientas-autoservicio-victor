const CACHE_PREFIX = 'autoservicio-v1230';
const CACHE_VERSION = 'autoservicio-v1230';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1230',
  './style.css?v=1230',
  './design-components.css?v=1230',
  './app-shell.css?v=1230',
  './app.js?v=1230',
  './config.js?v=1230',
  './excel.js?v=1230',
  './scanner.js?v=1230',
  './reposicion.js?v=1230',
  './ui.js?v=1230',
  './module-registry.js?v=1230',
  './shared/dom-utils.js?v=1230',
  './modules/tareas/task-view.js?v=1230',
  './modules/horarios/schedule-format.js?v=1230',
  './pwa.js?v=1230',
  './search.js?v=1230',
  './horarios-config.js?v=1230',
  './admin.js?v=1230',
  './auth.js?v=1230',

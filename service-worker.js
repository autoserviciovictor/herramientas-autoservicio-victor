const CACHE_PREFIX = 'autoservicio-v1200';
const CACHE_VERSION = 'autoservicio-v12.0.0';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1200',
  './style.css?v=1200',
  './design-components.css?v=1200',
  './app-shell.css?v=1200',
  './app.js?v=1200',
  './config.js?v=1200',
  './excel.js?v=1200',
  './scanner.js?v=1200',
  './reposicion.js?v=1200',
  './ui.js?v=1200',
  './module-registry.js?v=1200',
  './shared/dom-utils.js?v=1200',
  './modules/tareas/task-view.js?v=1200',
  './modules/horarios/schedule-format.js?v=1200',
  './pwa.js?v=1200',
  './search.js?v=1200',
  './horarios-config.js?v=1200',
  './admin.js?v=1200',
  './auth.js?v=1200',
  './notifications.js?v=1200',
  './prices.js?v=1200',
  './horarios.js?v=1200',
  './api-cache.js?v=1200',
  './tareas.js?v=1200',

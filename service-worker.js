const CACHE_PREFIX = 'autoservicio-v1203';
const CACHE_VERSION = 'autoservicio-v12.0.3';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1203',
  './style.css?v=1203',
  './design-components.css?v=1203',
  './app-shell.css?v=1203',
  './app.js?v=1203',
  './config.js?v=1203',
  './excel.js?v=1203',
  './scanner.js?v=1203',
  './reposicion.js?v=1203',
  './ui.js?v=1203',
  './module-registry.js?v=1203',
  './shared/dom-utils.js?v=1203',
  './modules/tareas/task-view.js?v=1203',
  './modules/horarios/schedule-format.js?v=1203',
  './pwa.js?v=1203',
  './search.js?v=1203',
  './horarios-config.js?v=1203',
  './admin.js?v=1203',
  './auth.js?v=1203',
  './notifications.js?v=1203',
  './prices.js?v=1203',
  './horarios.js?v=1203',
  './api-cache.js?v=1203',
  './tareas.js?v=1203',

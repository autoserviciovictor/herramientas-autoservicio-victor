...
const CACHE_VERSION = 'autoservicio-v1130-stable';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './design-tokens.css?v=1130',
  './style.css?v=1130',
  './design-components.css?v=1130',
  './app-shell.css?v=1130',
  './app.js?v=1130',
  './config.js?v=1130',
  './excel.js?v=1130',
  './scanner.js?v=1130',
  './reposicion.js?v=1130',
  './ui.js?v=1130',
  './module-registry.js?v=1130',
  './shared/dom-utils.js?v=1130',
  './modules/tareas/task-view.js?v=1130',
  './modules/horarios/schedule-format.js?v=1130',
  './pwa.js?v=1130',
  './search.js?v=1130',
  './horarios-config.js?v=1130',
  './admin.js?v=1130',
  './auth.js?v=1130',
  './notifications.js?v=1130',
  './prices.js?v=1130',
  './horarios.js?v=1130',
  './api-cache.js?v=1130',
  './tareas.js?v=1130',

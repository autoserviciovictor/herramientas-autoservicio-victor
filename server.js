...
app.get("/", (req, res) => {
  res.send("Servidor Herramientas Autoservicio Victor V4.3.1 funcionando");
});
...
app.listen(PORT, () => {
  console.log(`Servidor Herramientas Autoservicio Victor V4.3.1 funcionando en puerto ${PORT}`);
});

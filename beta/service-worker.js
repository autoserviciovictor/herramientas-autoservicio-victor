...
const CACHE_VERSION = 'autoservicio-beta-6112-entrega1';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './style.css?v=6112-entrega1',
  './app.js?v=6112-entrega1',
  './config.js?v=6112-entrega1',
  './excel.js?v=6112-entrega1',
  './scanner.js?v=6112-entrega1',
  './reposicion.js?v=6112-entrega1',
  './ui.js?v=6112-entrega1',
  './release-channel.js?v=6112-entrega1',
  './pwa.js?v=6112-entrega1',
  './search.js?v=6112-entrega1',
  './admin.js?v=6112-entrega1',
  './auth.js?v=6112-entrega1',
  './notifications.js?v=6112-entrega1',

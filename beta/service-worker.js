...
const CACHE_VERSION = 'autoservicio-beta-6113-entrega2';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './style.css?v=6113-entrega2',
  './app.js?v=6113-entrega2',
  './config.js?v=6113-entrega2',
  './excel.js?v=6113-entrega2',
  './scanner.js?v=6113-entrega2',
  './reposicion.js?v=6113-entrega2',
  './ui.js?v=6113-entrega2',
  './release-channel.js?v=6113-entrega2',
  './pwa.js?v=6113-entrega2',
  './search.js?v=6113-entrega2',
  './admin.js?v=6113-entrega2',
  './auth.js?v=6113-entrega2',
  './notifications.js?v=6113-entrega2',

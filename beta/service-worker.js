...
const CACHE_VERSION = 'autoservicio-beta-61161-quota-fix';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './style.css?v=61161-quota-fix',
  './app.js?v=61161-quota-fix',
  './config.js?v=61161-quota-fix',
  './excel.js?v=61161-quota-fix',
  './scanner.js?v=61161-quota-fix',
  './reposicion.js?v=61161-quota-fix',
  './ui.js?v=61161-quota-fix',
  './release-channel.js?v=61161-quota-fix',
  './pwa.js?v=61161-quota-fix',
  './search.js?v=61161-quota-fix',
  './admin.js?v=61161-quota-fix',
  './auth.js?v=61161-quota-fix',
  './notifications.js?v=61161-quota-fix',

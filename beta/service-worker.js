...
const CACHE_VERSION = 'autoservicio-beta-6118-precios';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './style.css?v=6118-precios',
  './app.js?v=6118-precios',
  './config.js?v=6118-precios',
  './excel.js?v=6118-precios',
  './scanner.js?v=6118-precios',
  './reposicion.js?v=6118-precios',
  './ui.js?v=6118-precios',
  './release-channel.js?v=6118-precios',
  './pwa.js?v=6118-precios',
  './search.js?v=6118-precios',
  './admin.js?v=6118-precios',
  './auth.js?v=6118-precios',
  './notifications.js?v=6118-precios',
  './prices.js?v=6118-precios',

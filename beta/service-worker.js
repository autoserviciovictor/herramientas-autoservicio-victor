...
const CACHE_VERSION = 'autoservicio-beta-6114-venc';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './style.css?v=6114-venc',
  './app.js?v=6114-venc',
  './config.js?v=6114-venc',
  './excel.js?v=6114-venc',
  './scanner.js?v=6114-venc',
  './reposicion.js?v=6114-venc',
  './ui.js?v=6114-venc',
  './release-channel.js?v=6114-venc',
  './pwa.js?v=6114-venc',
  './search.js?v=6114-venc',
  './admin.js?v=6114-venc',
  './auth.js?v=6114-venc',
  './notifications.js?v=6114-venc',

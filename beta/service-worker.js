...
const CACHE_VERSION = 'autoservicio-beta-71-entrega52-ios-camara';
const OFFLINE_DOCUMENT = './index.html';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './style.css?v=71-entrega52-ios-camara',
  './app.js?v=71-entrega52-ios-camara',
  './config.js?v=71-entrega52-ios-camara',
  './excel.js?v=71-entrega52-ios-camara',
  './scanner.js?v=71-entrega52-ios-camara',
  './reposicion.js?v=71-entrega52-ios-camara',
  './ui.js?v=71-entrega52-ios-camara',
  './release-channel.js?v=71-entrega52-ios-camara',
  './pwa.js?v=71-entrega52-ios-camara',
  './search.js?v=71-entrega52-ios-camara',
  './admin.js?v=71-entrega52-ios-camara',
  './auth.js?v=71-entrega52-ios-camara',
  './notifications.js?v=71-entrega52-ios-camara',
  './prices.js?v=71-entrega52-ios-camara',
  './api-cache.js?v=71-entrega52-ios-camara',

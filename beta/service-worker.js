...
const CACHE_VERSION = 'autoservicio-beta-71-entrega2-importacion';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './style.css?v=71-entrega2-importacion',
  './app.js?v=71-entrega2-importacion',
  './config.js?v=71-entrega2-importacion',
  './excel.js?v=71-entrega2-importacion',
  './scanner.js?v=71-entrega2-importacion',
  './reposicion.js?v=71-entrega2-importacion',
  './ui.js?v=71-entrega2-importacion',
  './release-channel.js?v=71-entrega2-importacion',
  './pwa.js?v=71-entrega2-importacion',
  './search.js?v=71-entrega2-importacion',
  './admin.js?v=71-entrega2-importacion',
  './auth.js?v=71-entrega2-importacion',
  './notifications.js?v=71-entrega2-importacion',
  './prices.js?v=71-entrega2-importacion',

...
const CACHE_VERSION = 'autoservicio-beta-6117-venc-rangos';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './style.css?v=6117-venc-rangos',
  './app.js?v=6117-venc-rangos',
  './config.js?v=6117-venc-rangos',
  './excel.js?v=6117-venc-rangos',
  './scanner.js?v=6117-venc-rangos',
  './reposicion.js?v=6117-venc-rangos',
  './ui.js?v=6117-venc-rangos',
  './release-channel.js?v=6117-venc-rangos',
  './pwa.js?v=6117-venc-rangos',
  './search.js?v=6117-venc-rangos',
  './admin.js?v=6117-venc-rangos',
  './auth.js?v=6117-venc-rangos',
  './notifications.js?v=6117-venc-rangos',

...
const CACHE_VERSION = 'autoservicio-beta-71-entrega1-catalogo';
const APP_SHELL = [
  './',
  './index.html',
  './xlsx.full.min.js',
  './style.css?v=71-entrega1-catalogo',
  './app.js?v=71-entrega1-catalogo',
  './config.js?v=71-entrega1-catalogo',
  './excel.js?v=71-entrega1-catalogo',
  './scanner.js?v=71-entrega1-catalogo',
  './reposicion.js?v=71-entrega1-catalogo',
  './ui.js?v=71-entrega1-catalogo',
  './release-channel.js?v=71-entrega1-catalogo',
  './pwa.js?v=71-entrega1-catalogo',
  './search.js?v=71-entrega1-catalogo',
  './admin.js?v=71-entrega1-catalogo',
  './auth.js?v=71-entrega1-catalogo',
  './notifications.js?v=71-entrega1-catalogo',
  './prices.js?v=71-entrega1-catalogo',

...
const CACHE_VERSION = 'autoservicio-v6.1.6.3-iconos-exactos';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=6162-identidad-ajustada',
  './app.js?v=6162-identidad-ajustada',
  './config.js?v=6162-identidad-ajustada',
  './excel.js?v=6162-identidad-ajustada',
  './scanner.js?v=6162-identidad-ajustada',
  './reposicion.js?v=6162-identidad-ajustada',
  './ui.js?v=6162-identidad-ajustada',
  './release-channel.js?v=6162-identidad-ajustada',
  './pwa.js?v=6162-identidad-ajustada',
  './search.js?v=6162-identidad-ajustada',
  './admin.js?v=6162-identidad-ajustada',
  './auth.js?v=6162-identidad-ajustada',
  './notifications.js?v=6162-identidad-ajustada',

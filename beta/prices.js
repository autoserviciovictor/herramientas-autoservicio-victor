import { API_BASE_URL } from './config.js?v=71-precios-fix';
import { iniciarScanner as iniciarScannerCompartido, detenerScanner as detenerScannerCompartido } from './scanner.js?v=71-precios-fix';
import { ordenarPorBusqueda } from './search.js?v=71-precios-fix';
